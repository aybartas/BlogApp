        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Definition = table.Column<int>(type: "int", maxLength: 80, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blogs_AppUsers_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorSurname = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AuthorEmail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PublishedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Blogs_RelatedBlogId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_RelatedBlogId",
                table: "Comments",
